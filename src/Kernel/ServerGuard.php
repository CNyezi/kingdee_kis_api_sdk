...
use Holt\KindeeKis\Kernel\Contracts\MessageInterface;
use Holt\KindeeKis\Kernel\Exceptions\BadRequestException;
use Holt\KindeeKis\Kernel\Exceptions\InvalidArgumentException;
use Holt\KindeeKis\Kernel\Messages\Message;
use Holt\KindeeKis\Kernel\Messages\News;
use Holt\KindeeKis\Kernel\Messages\NewsItem;
use Holt\KindeeKis\Kernel\Messages\Raw as RawMessage;
use Holt\KindeeKis\Kernel\Messages\Text;
use Holt\KindeeKis\Kernel\Support\XML;
use Holt\KindeeKis\Kernel\Traits\Observable;
use Holt\KindeeKis\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
    ...
    /**
     * @var \Holt\KindeeKis\Kernel\ServiceContainer
     */
    protected $app;
     ...
     * @codeCoverageIgnore
     *
     * @param \Holt\KindeeKis\Kernel\ServiceContainer $app
     */
     ...
     * @return $this
     *
     * @throws \Holt\KindeeKis\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\Holt\KindeeKis\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \Holt\KindeeKis\Kernel\Exceptions\InvalidArgumentException
     * @throws \Holt\KindeeKis\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \Holt\KindeeKis\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \Holt\KindeeKis\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \Holt\KindeeKis\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
